...
```
El modelo resultante de aplicar MOC1 a la dara de wage fue: 
...
Empezemos específicando el modelo resultante de aplicar el MCO a la dara de wage fomo función de las 9 variables preodictoas xi que componen el dataset. 
