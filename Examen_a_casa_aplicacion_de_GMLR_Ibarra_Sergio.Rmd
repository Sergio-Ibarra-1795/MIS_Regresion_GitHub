...
Los modelos lineales de MCO permitieron modelar a los datos de wage como función de variables sociodemográficas con un R^2 ajustado de 0.33 y teniendo un MAPE de 33% en el pronóstico de un set de test <br>
...
image <- read.jpeg("Regresion_examen_a_casa_resumen_resultados_modelos.png")

plot(image, width=600)
