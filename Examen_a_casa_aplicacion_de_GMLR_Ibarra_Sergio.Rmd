---
title: "Examen_a_casa_aplicacion_de_GMLR_Ibarra_Sergio"
author: "SIR"
date: "2023-12-05"
...
### Modelo MCO5 ( Logaritmo de variable dependiente wage como medida para lograr normalidad en error para observar si las variables descartadas en el MCO2 <black, midwest y south> )
...
# Fit linear model
olm_model5_wage_train_data <- lm(log(wage) ~ educ+exper+faminc+female+metro+ black + midwest + south, data = wage_train_data)

# View model summary
summary(olm_model5_wage_train_data)
```

Se observa como INCLUSO HACIENDO PRIMERO UNA TRANSFORMACIÓN DE LA VARIABLE y(wage) las variables black, midwest y south resultan ser NO SIGNIFICATIVAS 
...
Si tuviera que isar un modelo para pronósticar el wage como función de las variables presentadas usaria el MCO3 ó el MCG1  (requiere más capacidad computacional) dependiendo de la capacidad computacional con la que se cuente, teniendo un MAPE de aproximadamente 37% y un R'2 de alrededor de 0.48 
...
Los modelos lineales de MCO permitieron modelar a los datos de wage como función de variables sociodemográficas con un R^2 ajustado de 0.38 y teniendo un MAPE de 37% en el pronóstico de un set de test <br>

 <br>

Los  errores en los modelos MCO para el pronóstico de wage como función de variables sociodemográficas tiende a tener un comportamiento heterocedastico y no normal, así como presentar ligeras correlaciones  <br>
...
Los modelos lineales de MCG permitieron modelar a los datos de wage como función de variables sociodemográficas con un R^2 ajustado de 0.49 y teniendo un MAPE de 37% en el pronóstico de un set de test


#### Resumen de los resultados de los modelos MCO y MCG probados en el presente trabajo  
...
image <- readPNG("Regresion_examen_a_casa_resumen_resultados_modelos.png")
...
Dunn, P. K., & Smyth, G. K. (2005). Generalized linear models with examples in R. Springer.
...
https://gente.itam.mx/lnieto/index_archivos/NotasRA4.pdf
...
Reference: https://cran.r-project.org/web/packages/lmtest/citation.html
...
Reference: https://cran.r-project.org/web/packages/lrmest/citation.html
...
coefplot:
Lüdecke, D. (2021). sjPlot: Data Visualization for Statistics in Social Science. https://cran.r-project.org/web/packages/sjPlot/citation.html

<br>
nlme:
Pinheiro, J., Bates, D., DebRoy, S., Sarkar, D., & R Core Team (2021). nlme: Linear and Nonlinear Mixed Effects Models. R package version 3.1-154.
Reference: https://cran.r-project.org/web/packages/nlme/citation.html
