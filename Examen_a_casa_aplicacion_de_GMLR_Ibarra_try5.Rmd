...
coefficients <- coef_summary_glm_1_wage_train_data$Value
lower_bound <- coef_summary_glm_1_wage_train_data$"2.5 %"
upper_bound <- coef_summary_glm_1_wage_train_data$"97.5 %"

# Create a dataframe for plotting
plot_data <- data.frame(Coefficient = coefficients, Lower = lower_bound, Upper = upper_bound)

# Plot coefficients with confidence intervals for GLS model using ggplot2
ggplot(plot_data, aes(y = Coefficient, x = 1)) +
  geom_point() +
  geom_errorbarh(aes(xmin = Lower, xmax = Upper), height = 0.2) +
  labs(title = "GLS Model Coefficients and Confidence Intervals", x = "", y = "Coefficient")
...
```{r}
# Predict wages using the test data
wage_predicted_glm_1 <- predict(glm_1_wage_train_data, newdata = wage_test_data)
